                        ...
                        <div class="row mt-3 mx-3" style="margin-top:25px ;">
                            <div class="col-md-3">
                                <div style="margin-top: 50px; margin-left: 10px;" class="text-center">
                                    <i id="animationDemo" data-mdb-animation="slide-right" data-mdb-toggle="animation" data-mdb-animation-reset="true" data-mdb-animation-start="onScroll" data-mdb-animation-on-scroll="repeat" class="fas fa-3x fa-shipping-fast text-white"></i>
                                    ...
                                    <div class="card-body mt-0 mx-5">
                                        ...
                                        <form class="mb-0" method="post">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <div class="form-outline">
                                                        <input type="text" name="fullname" id="form9Example1" class="form-control input-custom" required/>
                                                ...
                                                <div class="col">
                                                    <div class="form-outline">
                                                        <input type="tel" name="phoneno" id="form9Example2" class="form-control input-custom" placeholder="123-456-789" required/>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <div class="form-outline">
                                                        <input type="text" name="city" id="form9Example3" class="form-control input-custom" required/>
                                                ...
                                                <div class="col">
                                                    <div class="form-outline">
                                                        <input type="text" name="zipcode" id="form9Example4" class="form-control input-custom" required/>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <div class="form-outline">
                                                        <input type="text" name="address" id="form9Example6" class="form-control input-custom" required/>
                                            ...
                                            <div class="float-end ">
                                                <!-- Submit button -->
                                                <button type="submit" name="submit" class="btn btn-primary btn-rounded" style="background-color: #0062CC ;">Add Address</button>
                                                <!-- /Submit button -->
                                            </div>
                                        </form>
