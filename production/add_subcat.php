                ...
                <div class="x_content">
                  ...
                  <div class="x_content">
                    <form name="categories" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="">Sub Category Name
                          <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="subcategory" id="first-name" required="required" class="form-control ">
                        </div>
                      </div>
                      <br>
                      <div class="item form-group">
                    ...
                    if (isset($_POST['submit'])) {
                      ...
                      $query = "insert into scategory values('','$catname','$subcategory')";
                          ...
                          <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                  <a href="delete_subcate.php?catid=<?php echo $row['catid']; ?>" class="btn btn-danger btn-sm active" role="button" aria-pressed="true">delete</a>
                                </td>
                              </tr>
                            <?php
                              $c++;
