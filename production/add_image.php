                ...
                <div class="x_content">
                  ...
                  <form name="addimage" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="">Add Your Image
                        <span class="required"></span>
                      </label>
                      <div class="col-md-6 col-sm-6 ">
                        <input type="file" name="image" id="first-name" required="required" class="form-control ">
                      </div>
                    </div>
                    <!-- /upload profile photo -->
                    <br>
                    <div class="item form-group">
                      <div class="col-md-6 col-sm-6 offset-md-3">
                        <button type="submit" name="submit" class="btn btn-success">Add your Image</button>
                      </div>
                    </div>
                  </form>
                  <?php
                  ...
                  if (isset($_POST['submit'])) {
                    ...
                    $queryexist = "select * from addimage";
                    $res = mysqli_query($con, $queryexist);
                    $query = "insert into addimage values('','$id','$image_name')";
                            ...
                            <div class="card-box table-responsive">
                              <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                  <?php
                                  $c = 1;
                                  $queryselect = "select * from addimage WHERE cid='$id'";
                                  $res = mysqli_query($con, $queryselect);
                                  while ($row = mysqli_fetch_assoc($res)) {
                                  ?>
                                    <tr>
                                      <td><?php echo $c; ?></td>
                                      <td><a href="upload/<?php echo $row['cid']; ?>" target="_blank"><img src="dataimage/<?php echo $row['image']; ?>" width="100px" height="100px"></a></td>
                                      <td>
                                        <a href="delete_imgtable.php?cid=<?php echo $row['id'];?>" class="btn btn-danger btn-sm active" role="button" aria-pressed="true">delete</a>
                                      </td>
                                    </tr>
                                  <?php
                                    $c++;
