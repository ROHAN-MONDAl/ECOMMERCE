                      ...
                      <div class="card-box table-responsive">
                        <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <?php
                            $c = 1;
                            $queryselect = "select * from usersdata";
                            $res = mysqli_query($con, $queryselect);
                            while ($row = mysqli_fetch_assoc($res)) {
                            ?>
                              <tr>
                                <td><?php echo $c; ?></td>
                                <td><a href="upload/<?php echo $row['profilephoto']; ?>" target="_blank"><img src="adminupload/<?php echo $row['profilephoto']; ?>" width="100px" height="100px"></a></td>
