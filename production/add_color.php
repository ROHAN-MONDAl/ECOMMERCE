                  ...
                  <div class="x_content">
                    ...
                    <form name="categories" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="">Add Your Color
                          <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="color" id="first-name" required="required" class="form-control ">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                          <button type="submit" name="add" class="btn btn-success">Add Color</button>
                        </div>
                      </div>
                    </form>
                    ...
                    if (isset($_POST['add'])) {
                      $color = $_POST['color'];
                      $queryexist = "select * from addcolor WHERE pid='$id' && color='$color'";
                      $res = mysqli_query($con, $queryexist);
                      $rc = mysqli_num_rows($res);
                      if ($rc == 0) {
                      $query = "insert into addcolor values('','$id','$color')";
                          ...
                          <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                              <tr class="headings">
                                ...
                                <th class="column-title">Add Image</th>
                            ...
                            <tbody>
                              <?php
                              $c = 1;
                              $queryselect = "select * from addcolor WHERE pid='$id'";
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td> <a href="../production/add_image.php?cid=<?php echo $row['id'] ?>">Add Image</a> </td>
                                  <td>
                                    <a href="delete_color.php?pid=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm active" role="button" aria-pressed="true">delete</a>
                                  </td>
                                </tr>
                              <?php
                                $c++;
