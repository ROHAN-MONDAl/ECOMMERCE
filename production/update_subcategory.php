                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form name="categories" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="">Subs Category
                                                <span class="required"></span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" name="subcategory" required="required" class="form-control">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="item form-group">
                                    ...
                                    if (isset($_POST['update'])) {
                                        ...
                                        $sql = "UPDATE subcategory SET category='$category',subcategory='$subcategory'  WHERE slno='$slno'";

                                        if (mysqli_query($con, $sql)) {
                                            echo "<script>alert('your data will be saved');window.location.href='add_items_categories.php'</script>";
                                        } else {
