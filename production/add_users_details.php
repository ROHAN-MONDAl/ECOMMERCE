      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a class="site_title"><i class="fa fa-paw"></i> <span>Ecommerce</span></a>
          </div>
                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        ...
                        <tr class="headings">
                          ...
                          <th class="column-title">Users Password</th>
                          </th>
                        </tr>
                      </thead>
                          <tbody>
                          <?php
                        $c = 1;
                        $queryselect = "select * from euserdata";
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $row['euseremail']; ?></td>
                            <td><?php echo $row['euserpassword']; ?></td>
                          </tr>
                        <?php
                          $c++;
                        }
