                ...
                <div class="x_content">
                  ...
                  <div class="x_content">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="">Add Your Size
                          <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="productsize" id="first-name" required="required" class="form-control ">
                        </div>
                      </div>
                      <br>
                      <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                          <button type="submit" name="add" class="btn btn-success">Add Size</button>
                        </div>
                      </div>
                    </form>
                    ...
                    if (isset($_POST['add'])) {
                      ...
                      $query = "insert into psize values('','$id','$pname','$productsize')";
                        ...
                        <div class="card-box table-responsive">
                          <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                              ...
                              <?php
                              $c = 1;
                              $queryselect = "select * from psize WHERE pid='$id'";
                              $res = mysqli_query($con, $queryselect);
                              while ($row = mysqli_fetch_assoc($res)) {
                              ?>
                                <tr>
                                  ...
                                  <td>
                                    <a href="delete_size.php?pid=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm active" role="button" aria-pressed="true">delete</a>
                                  </td>
                                </tr>
                              <?php
                                $c++;
