...
<?php
$id = $_GET['id'];
$queryexist = "select * from product where id = '$id'";
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form name="categories" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" name="brand" id="first-name" required="required" class="form-control " value="<?php echo $row['brand']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <input type="text" name="name" id="first-name" required="required" class="form-control " value="<?php echo $row['name']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <textarea class="form-control" name="pdes" rows="3"><?php echo $row['pdes']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <textarea class="form-control" name="phigh" rows="3"><?php echo $row['phigh']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <textarea class="form-control" name="pspecs" rows="3"><?php echo $row['pspecs']; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <textarea class="form-control" name="pdimen" rows="3"><?php echo $row['pdimen']; ?></textarea>
                                                </div>
                                            </div>
                                        ...
                                        if (isset($_POST['update'])) {
                                            ...
                                            $sql = "UPDATE product SET brand='$brand',name='$name',pdes='$pdes',phigh='$phigh',pspecs='$pspecs',pdimen='$pdimen' WHERE id ='$id'";
                                            if (mysqli_query($con, $sql)) {
                                                echo "<script>alert('your data will be saved');window.location.href='add_product.php'</script>";
                                            } else {
