                  ...
                  <div class="x_content">
                    ...
                    <form name="categories" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="">Add Your Ratings
                          <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="ratings" id="first-name" required="required" class="form-control ">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        <div class="col-md-6 col-sm-6 offset-md-3">
                          <button type="submit" name="add" class="btn btn-success">Add Ratings</button>
                        </div>
                      </div>
                    </form>
                    ...
                    if (isset($_POST['add'])) {
                      ...
                      $query = "insert into ratings values('','$id','$ratings')";
                        ...
                        <div class="card-box table-responsive">
                          <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                              <?php
                              $c = 1;
                              $queryselect = "select * from ratings WHERE pid='$id'";
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td>
                                    <a href="delete-ratings.php?pid=<?php echo $row['id'];?>" class="btn btn-danger btn-sm active" role="button" aria-pressed="true">delete</a>
                                  </td>
                                </tr>
                              <?php
                                $c++;
